...
public class ClickPostActivity extends AppCompatActivity {
    ...
    private Button EditPostButtoon, DeletePostButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditPostButtoon=findViewById(R.id.edit_post_button);
        DeletePostButton=findViewById(R.id.delete_post_button);


        EditPostButtoon.setVisibility(View.INVISIBLE);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    if(currentUserID.equals(databaseUserId)){
                        ...
                        EditPostButtoon.setVisibility(View.VISIBLE);
                        DeletePostButton.setVisibility(View.VISIBLE);

                    }

                    EditPostButtoon.setOnClickListener(new View.OnClickListener() {
                        @Override
